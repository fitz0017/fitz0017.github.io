    ...
    <div className="card-body align-items-center">
      ...
      <div style={{ display: "flex" }}>
        <p className="card-text align-middle" style={{ width: "66%" }}>
          ...
          engineer, and general tinkerer. I've worked in and with technology all
          of my adult life, beginning my professional career in the USAF and
          spending the last 10 years in customer engineering working with
          enterprise customers. On this page, I'd like to share some of the work
          I've done across development, infrastructure as code and other
          technologies.
          <br />
          <br />
          I've been fortunate to work with customers across multiple industries
          including manufacturing, healthcare and finance.
          <br />
          <br />
          It is an exciting time in technology and I hope to explore AI in depth
          and share those projects here as well.
        </p>
        <iframe
          width={560}
          height={315}
      ...
      <p>
        For more detailed information about previous work and education, or to
        get in touch -- see my{" "}
        <a
  ...
  >
    ...
    >
      ...
      <div className="card-body">
        ...
        <p className="card-text">
          PacMen Chaos! App has two buttons. One to add PacMen to the screen in
          a random location with a random speed, and a second to start the
          animation and have the PacMen run wild within the window area. PacMen
          should change facing direction when bouncing off the left and right
          walls.
        </p>
        <a
    ...
    >
      ...
      <div className="card-body">
        ...
        <p className="card-text">
          ...
          near-realtime location on a Google Map on the MBTA Bus Route #1. It
          updates every 15 seconds from the MBTA API. Uses standard light
    ...
    >
      ...
      <div className="card-body">
        ...
        <a href="https://github.com/fitz0017/eyes" className="btn btn-primary">
          Github Repo
        </a>
      </div>
    </div>
